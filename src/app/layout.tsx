...
export const metadata: Metadata = {
  ...
  description:
    "Décorateur, cuisiniste, menuisier, artisan : vous n'apparaissez pas assez sur Google ? J'analyse votre fiche Google Business Profile, vos avis et votre présence locale, et vous remets un plan d'action priorisé. Diagnostic SEO local à 490 €.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Vous n'apparaissez pas assez sur Google ? J'analyse votre fiche Google Business Profile, vos concurrents et votre présence locale. Plan d'action priorisé livré sous 5 jours. 490 €.",
    siteName: "Laeti SEO",
  },
  twitter: {
    ...
    description:
      "Décorateur, cuisiniste, menuisier, artisan : comprenez pourquoi vous n'apparaissez pas assez sur Google. Diagnostic SEO local à 490 €.",
  },
  verification: {
