      ...
      hasOfferCatalog: {
        ...
        itemListElement: [
          ...
          },
          {
            ...
            price: '1500',
            priceCurrency: 'EUR',
            description: 'Diagnostic inclus, optimisation complète de la fiche Google, stratégie avis clients, optimisations SEO on-page, suivi mensuel et accès direct par WhatsApp pendant 3 mois. Payable en 3 mensualités de 500 €.',
          },
        ],
      },
    },
            ...
            <ScrollReveal>
              ...
              <div className="flex flex-wrap items-center justify-center gap-4">
                ...
                <Link
                  ...
                  style={{ fontFamily: inter.style.fontFamily, fontSize: '14px' }}
                >
                  Voir le Sprint local 3 mois · 500 €/mois
                  <ArrowRight size={13} weight="bold" />
                </Link>
                <a
