...
export const metadata: Metadata = {
  ...
  description:
    "Deux offres SEO local pour les professionnels de l'habitat : un diagnostic de visibilité à 490 € livré sous 5 jours, ou un sprint d'accompagnement de 3 mois à 500 €/mois (3 mois minimum). Découvrez le détail, le déroulé et les tarifs.",
  alternates: {
